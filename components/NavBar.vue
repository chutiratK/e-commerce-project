<template>
  <nav>
    <v-app-bar flat app elevation="4" rounded>
      ...
      <v-menu offset-y>
        ...
        <v-list style="background-color: rgba(255, 254, 254, 0.9)">
          <v-list-item @click="pet" class="sub-menu-link">
            <v-list-item-title style="color: #525252">pet</v-list-item-title>
          </v-list-item>
          <v-list-item @click="skincare" class="sub-menu-link">
            <v-list-item-title style="color: #525252"
              >skincare</v-list-item-title
            >
          </v-list-item>
          <v-list-item @click="electronics" class="sub-menu-link">
            <v-list-item-title style="color: #525252"
              >electronics</v-list-item-title
            >
          </v-list-item>
          <v-list-item @click="furniture" class="sub-menu-link">
            <v-list-item-title style="color: #525252"
              >furniture</v-list-item-title
            >
          </v-list-item>
        </v-list>
      </v-menu>
