    ...
    <div class="col-md-4 mt-1">
        <div class="card text-center sidebar">
            <div class="sub-sidebar">
                <NuxtLink to="/account/profile" class="sub-sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                    <p>PROFILE</p>
                    <span>></span>
                </NuxtLink>
                <NuxtLink to="/account/address" class="sub-sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512"><path fill="#000000" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>
                    <p>ADDRESS</p>
                    <span>></span>
                </NuxtLink>
                <NuxtLink to="/account/wishList" class="sub-sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z"/></svg>
                    <p>WISH LIST</p>
                    <span>></span>
                </NuxtLink>
                <NuxtLink to="/account/order" class="sub-sidebar-link">
                ...
                <NuxtLink to="#" class="sub-sidebar-link">
...
.sub-sidebar-link span {
    color: #525252;
    margin-left: 35px;
    margin-right: 15px;
}
.sub-sidebar-link svg {
    width: 40px;
    margin-left: 15px;
}
</style>