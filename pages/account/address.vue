          ...
          <div class="card mb-3 content">
            ...
            <div class="card-body">
              <div class="addressCard">
                ...
                <div v-for="(address, index) in paginatedData" :key="index">
                  <div class="item">
                    <input
                      type="radio"
                      :id="'radioo' + index"
                    ...
                    <div class="icons">
                      <span
                        class="pen"
                        @click="editAddressIcon(address.addressID)"
                      >
                        <svg
            ...
            >
              ...
              <div class="createAddress">
                <div class="row">
                  ...
                  <div class="addrdiv">
                    <label for="addr" class="input-label"
          ...
          <v-dialog v-model="editAddressModal" max-width="550px">
            ...
            >
              ...
              <div class="createAddress">
                ...
                <center>
                  <v-btn @click="editAddress" class="addressBtn" color="blue"
                    >Edit</v-btn
                  >
                  <!-- <v-btn @click="cancelEditName" color="red">cancel</v-btn><br> -->
                </center>
